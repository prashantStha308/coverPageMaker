...
const CombinedForm = ({handleClick}) => {
    return (
        <section id="combinedForm" className="my-auto w-screen flex flex-col md:flex-row md:justify-evenly gap-20 md:gap-0 items-center" >
            ...
            <div className="flex flex-col gap-2 text-white font-bold text-center bg-black/25 rounded-sm border-[#27513E] border-1 p-5 box-border backdrop-blur-2xl shadow-xl" >
